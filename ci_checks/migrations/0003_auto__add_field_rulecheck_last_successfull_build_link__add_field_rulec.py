...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RuleCheck.last_successfull_build_link'
        db.add_column(u'ci_checks_rulecheck', 'last_successfull_build_link',
                      self.gf('django.db.models.fields.URLField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'RuleCheck.last_failed_build_link'
        db.add_column(u'ci_checks_rulecheck', 'last_failed_build_link',
                      self.gf('django.db.models.fields.URLField')(default=u'', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RuleCheck.last_successfull_build_link'
        db.delete_column(u'ci_checks_rulecheck', 'last_successfull_build_link')

        # Deleting field 'RuleCheck.last_failed_build_link'
        db.delete_column(u'ci_checks_rulecheck', 'last_failed_build_link')
    ...
    models = {
        ...
        u'ci_checks.rulecheck': {
            ...
            'last_failed_build_link': ('django.db.models.fields.URLField', [], {'default': "u''", 'max_length': '200', 'blank': 'True'}),
            'last_successfull_build_link': ('django.db.models.fields.URLField', [], {'default': "u''", 'max_length': '200', 'blank': 'True'}),
